...
fn exec_cargo_for_onchain_target(
    ...
    let cargo_build = |manifest_path: &ManifestPath| {
        ...
        // warnings.
        let rustflags = {
            let common_flags = "-Crelocation-model=pic\x1f-Clto=no\x1f-Clink-arg=-zstack-size=4096";
...
fn local_build(
    ...
    config.set_debug_json_output_path(Some("/Users/maliketh/ink/ink-sandbox-trace/ink-debugger/examples/flipper/debug__.json"));
